...
export default {
    ...
    methods: {
        ...
        onSaveSuccess () {
            ...
            // no funciona, y tampoco $emit ni $dispatch
            this.$broadcast('alert-icon:show', 'save-success')
        },
        onSaveError () {
            this.onSaveCompleted()
            // no funciona, y tampoco $emit ni $broadcast
            this.$dispatch('alert-icon:show', 'save-error')
        },
        onSaveCompleted () {
            this.editing = false
    ...
    components: {TransItemValues, TransItemHeader},
