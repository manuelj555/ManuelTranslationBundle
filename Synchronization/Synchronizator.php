...
class Synchronizator
{
    ...
    public function updateTranslation(Translation $translation, $values, $files, $hash, $active, $new, $autogenerated, $changed = false)
    {
        ...
        $translation->setChanged((bool)$changed);
        ...
        foreach ($fileTranslations as $domain => $translations) {
            ...
            foreach ($translations as $code => $t) {
                if (isset($dbTranslations[$domain][$code])) {
                    ...
                    if ($this->withOutConflicts($t, $dbT) or !$dbT->getChanged()) {
