...
class Synchronizator
{
    ...
    public function generateFile()
    {
        ...
        foreach ($translations as $translation) {
            $export['translations'][$translation['domain']][$translation['code']] = array(
                'values' => $this->getValidValues($translation['values']),
    ...
    public function updateTranslation(Translation $translation, $values, $files, $hash, $active, $new, $autogenerated)
    {
        ...
        foreach ($fileTranslations as $domain => $translations) {
            ...
            foreach ($translations as $code => $t) {
                if (isset($dbTranslations[$domain][$code])) {
                    ...
                    if ($this->withOutConflicts($t, $dbT)) {
    ...
    {
        if ($file->getValues() == $database->getValues() and
            $file->getFiles() == $database->getFiles() and
            $file->getActive() == $database->getActive()
        ) {
            return true;
