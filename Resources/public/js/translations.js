...
},{"../vue/components/TransList.vue":7,"babel-runtime/core-js/object/assign":9,"vue":50}],2:[function(require,module,exports){
...
var _AlertIcon = require('../directives/AlertIcon.vue');
...
exports.default = {
	...
	directives: { Loading: _vueLoading2.default, AlertIcon: _AlertIcon2.default }
...
},{"../directives/AlertIcon.vue":8,"./TransItemFiles.vue":3,"./TransItemHeader.vue":4,"./TransItemValues.vue":6,"vue":50,"vue-hot-reload-api":47,"vue-loading":48,"vueify/lib/insert-css":51}],3:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
...
exports.default = {
	...
	bind: function bind() {
		...
		this.vm.$on('alert-icon:show', function (reference) {
			//console.log(this.elementRef, reference)
			if (reference !== _this.elementRef) {
				return true;
			}
