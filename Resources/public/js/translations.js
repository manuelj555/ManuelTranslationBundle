...
_vue2.default.config.lang = TranslationData.locale;
_vue2.default.locale(TranslationData.locale, _locales2.default[TranslationData.locale]);
...
},{"../vue/components/TransList.vue":10,"../vue/plugins/TranslationData.js":12,"./locales.js":2,"vue":78,"vue-i18n":75}],2:[function(require,module,exports){
'use strict';
...
},{"vue":78,"vue-hot-reload-api":74,"vueify/lib/insert-css":79}],4:[function(require,module,exports){
'use strict';
...
exports.default = {
    props: {
        ...
        filters: {
            ...
            type: [Object],
            twoWay: true,
            coerce: function coerce(filters) {
    ...
    methods: {
        updateDomains: function updateDomains(domain) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-0da9d8e5", module.exports)
  } else {
    hotAPI.update("_v-0da9d8e5", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":78,"vue-hot-reload-api":74}],5:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
...
exports.default = {
	...
	events: {
		'save-values': function saveValues() {
			this.save();
		},
...
},{"../directives/AlertIcon.vue":11,"./TransItemFiles.vue":6,"./TransItemHeader.vue":7,"./TransItemValues.vue":9,"vue":78,"vue-hot-reload-api":74,"vue-loading":76,"vueify/lib/insert-css":79}],6:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
...
},{"vue":78,"vue-hot-reload-api":74,"vueify/lib/insert-css":79}],7:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\n.trans-item-header {\n\tcursor: pointer;\n}\n")
'use strict';
...
},{"./DomainForm.vue":3,"vue":78,"vue-hot-reload-api":74,"vueify/lib/insert-css":79}],8:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
...
},{"vue":78,"vue-hot-reload-api":74,"vueify/lib/insert-css":79}],9:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
...
exports.default = {
	...
	created: function created() {
		...
		try {
			for (var _iterator = (0, _getIterator3.default)(this.locales), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	...
	methods: {
		...
		hasChanges: function hasChanges() {
			return !_lodash2.default.isEqual(this.values, this.originalValues);
		}
	},
...
},{"./TransItemValue.vue":8,"babel-runtime/core-js/get-iterator":13,"babel-runtime/core-js/object/assign":14,"lodash":73,"vue":78,"vue-hot-reload-api":74,"vueify/lib/insert-css":79}],10:[function(require,module,exports){
'use strict';
...
var _TransFilter = require('./TransFilter.vue');

var _TransFilter2 = _interopRequireDefault(_TransFilter);
...
exports.default = {
    ...
    methods: {
        getTranslations: function getTranslations() {
            ...
            this.isLoading = true;
            return this.resource.get(this.filters).then(function (res) {
    ...
    events: {
        ...
        'filter:translations:submit': function filterTranslationsSubmit() {
            this.getTranslations();
        }
    },

    components: { TransItem: _TransItem2.default, TransFilter: _TransFilter2.default },
...
},{"./TransFilter.vue":4,"./TransItem.vue":5,"vue":78,"vue-hot-reload-api":74,"vue-loading":76,"vue-resource":77}],11:[function(require,module,exports){
'use strict';
...
},{"vue":78,"vue-hot-reload-api":74}],12:[function(require,module,exports){
"use strict";
...
},{"core-js/library/fn/get-iterator":15}],14:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/object/assign"), __esModule: true };
},{"core-js/library/fn/object/assign":16}],15:[function(require,module,exports){
...
},{"_process":72}],76:[function(require,module,exports){
...
},{"_process":72}],79:[function(require,module,exports){
